...
from app import agent_card, app
...
async def test_a2a_agent_execution_rest():
    ...
    async with httpx.AsyncClient(
        ...
        status_events = [
            e.status_update for e in events if e.WhichOneof("payload") == "status_update"
        ]
        ...
        artifact_events = [
            e.artifact_update for e in events if e.WhichOneof("payload") == "artifact_update"
        ]
